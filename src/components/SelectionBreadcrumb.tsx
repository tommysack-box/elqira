...
export function SelectionBreadcrumb() {
  ...
  return (
    <nav className="px-6 py-2 flex items-center gap-1.5 bg-[#f2f4f6]/50 backdrop-blur-sm sticky top-12 z-30 overflow-x-auto">
      {/* Project pill */}
      <button
        onClick={() => {
        ...
        className="flex items-center gap-1.5 px-2.5 py-1 bg-[#e6e8ea] rounded-full flex-shrink-0 cursor-pointer hover:bg-[#e0e3e5] transition-colors group"
      >
      ...
      {currentScenario && (
        <>
          <span className="text-[#c7c4d7] text-[11px] flex-shrink-0">/</span>
          <button
            onClick={() => {
              setCurrentRequest(null);
              setView('requests');
            }}
            className="flex items-center gap-1.5 px-2.5 py-1 bg-[#e6e8ea] rounded-full flex-shrink-0 cursor-pointer hover:bg-[#e0e3e5] transition-colors"
          >
      ...
      {currentRequest && (
        <>
          ...
          <div className="flex items-center gap-1.5 px-2.5 py-1 bg-white border border-[#2a14b4]/20 rounded-full flex-shrink-0 shadow-sm">
